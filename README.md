...
Latest release: 0.1.9 -  [Changelog](CHANGELOG.md) | [Docker Hub](https://hub.docker.com/r/osixia/openldap-backup/) 
...
- [Advanced User Guide](#advanced-user-guide)
	- [Extend osixia/openldap-backup:0.1.9 image](#extend-osixiaopenldap-backup019-image)
...
## Quick start
    ...
    docker run --volumes-from openldap --detach osixia/openldap-backup:0.1.9
...
Example command to run the container in `debug` mode:
	...
	docker run --detach osixia/openldap-backup:0.1.9 --loglevel debug

See all command line options:

	docker run osixia/openldap-backup:0.1.9 --help
...
Environment variables can be set by adding the --env argument in the command line, for example:
    ...
    --detach osixia/openldap-backup:0.1.9
